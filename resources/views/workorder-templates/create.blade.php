        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-file-alt"></i> 创建工单模板
                    </h3>
                ...
                <form method="POST" action="{{ route('workorder-templates.store') }}">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="category_main" name="category_main" required>
                                        ...
                                        @foreach($categoryOptions['main'] as $category)
                                            <option value="{{ $category->id }}" {{ old('category_main') == $category->id ? 'selected' : '' }}>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class="form-control" id="category_sub" name="category_sub" required>
                                        ...
                                        @if(old('category_main'))
                                            @foreach($categoryOptions['sub'][old('category_main')] ?? [] as $category)
                                                <option value="{{ $category->id }}" {{ old('category_sub') == $category->id ? 'selected' : '' }}>
                                                    {{ $category->name }}
                                                </option>
                                            @endforeach
                                        @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="campus" name="campus">
                                        ...
                                        @foreach(\App\Models\WorkorderTemplate::getCampusOptions() as $value => $label)
                                            <option value="{{ $value }}" {{ old('campus') == $value ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="time_limit_hours" name="time_limit_hours" 
                                           value="{{ old('time_limit_hours') }}" min="1" max="168">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="location_detail" name="location_detail" rows="2">{{ old('location_detail') }}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="other_reason" name="other_reason" value="{{ old('other_reason') }}">
                                    @error('other_reason')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
