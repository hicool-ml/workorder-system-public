                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label for="new_attachments" class="label">上传新附件</label>
                                ...
                                <input type="file" class="sr-only" id="new_attachments" name="new_attachments[]" multiple accept="*/*" onchange="document.getElementById('attEditName').textContent=this.files.length?'已选择 '+this.files.length+' 个文件':'未选择文件'">
