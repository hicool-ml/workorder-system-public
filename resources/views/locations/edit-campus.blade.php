...
<div class="flex items-center justify-between mb-6">
    <h1 class="text-xl font-semibold text-ink">编辑区域</h1>
...
<div class="max-w-2xl">
    <div class="card p-6">
        <form method="POST" action="{{ route('locations.update-campus', $campus->id) }}">
            @csrf
            @method('PUT')
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" class="input" id="name" name="name"
                           value="{{ old('name', $campus->name) }}" required maxlength="255"
                ...
                <div>
                    ...
                    <textarea class="input" id="description" name="description" rows="3"
                              placeholder="选填，区域的详细描述">{{ old('description', $campus->description) }}</textarea>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" class="input" id="sort_order" name="sort_order"
                               value="{{ old('sort_order', $campus->sort_order) }}" min="0" autocomplete="off">
