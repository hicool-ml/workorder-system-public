    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">编辑地址信息</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('locations.update', $location->id) }}">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="name" name="name" 
                                   ...
                                   placeholder="如：老校区1-7教">
                        </div>
                        <div class="col-md-6">
                            <label for="building_code" class="form-label">楼栋代码</label>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-4">
                            ...
                            <select class="form-select" id="campus" name="campus" required>
                                ...
                                <option value="{{ $key }}" {{ old('campus', $location->campus) == $key ? 'selected' : '' }}>
                                    {{ $value }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="sort_order" name="sort_order" 
                                   value="{{ old('sort_order', $location->sort_order) }}" min="0">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="3"
                                  placeholder="地址的详细描述">{{ old('description', $location->description) }}</textarea>
                    </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <ul class="mb-0">
                    ...
                    <li><strong>楼栋代码：</strong>楼栋的编号，如"1-7"、"8-14"、"A-J"</li>
